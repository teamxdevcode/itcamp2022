...
<div class="h-screen flex mt-10 md:mt-0 items-center justify-center flex-col space-y-10 max-w-screen overflow-hidden">
  ...
  <div class="h-1/3">
    <a href="{{route('home')}}" class="bg-[#1877F2] text-white flex px-8 py-4 space-x-4 rounded-md border-b-8 border-r-2 hover:translate-y-2 hover:border-b-4 transition-all ease-in-out duration-200 border-blue-900">
