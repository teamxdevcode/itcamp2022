<div>
  ...
  @elseif($user->registration->result == 2)
    <img src="{{asset('image/hand.svg')}}" alt="" class="w-16 mx-auto mb-6">
    <p class="text-xl md:text-2xl font-bold mb-3 md:mb-2">ยินดีด้วย !!  น้องอยู่ในรายชื่อตัวสำรอง</p>
    <p class="mb-8">หากน้องได้รับสิทธิ์เป็นตัวจริง พี่จะรีบทำการติดต่อกลับภายในวันที่ 2 กรกฎาคม 2565</p>
  @endif
</div>
