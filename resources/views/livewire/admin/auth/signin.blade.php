<form wire:submit.prevent="submit" class="flex flex-col gap-3 w-full max-w-sm">
  ...
  <div class="relative">
    <input type="text" wire:model.defer="username" id="username" class="bg-gray-200 rounded-xl outline-0 p-3 pl-[7rem] w-full border border-transparent {{($errors->has('username') || $errors->has('failed')) ? 'border-red-600 text-red-600 pr-12':''}}">
  ...
  <div class="relative">
    <input type="password" wire:model.defer="password" id="password" class="bg-gray-200 rounded-xl outline-0 p-3 pl-[7rem] w-full border border-transparent {{($errors->has('password') || $errors->has('failed')) ? 'border-red-600 text-red-600 pr-12':''}}">
  ...
  @endphp
  <button type="submit" wire:loading.attr="disabled" class="p-3 bg-blue-600 hover:bg-blue-500 transition-all duration-300 rounded-xl text-white mt-3">Sign in</button>
</form>
