<div class="w-full {{$full}} mb-5">
  ...
  <input
    type="{{$type}}"
    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium @error($binding)ring ring-red-600/50 ring-1 @enderror"
    placeholder="{{$placeholder}}"
    wire:model.lazy="{{$binding}}"/>
</div>
