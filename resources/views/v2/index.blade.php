...
<div class="text-center max-w-xl py-8">
  ...
  <a href="{{route('auth.login')}}" class="bg-blue-700 hover:bg-blue-600 transition-all duration-300 p-3 px-8 block rounded-xl max-w-[16rem] mx-auto active:bg-blue-800">ดำเนินการต่อด้วย Facebook</a>
</div>
@endsection
